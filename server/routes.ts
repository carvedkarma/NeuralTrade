  ...
  app.post("/api/live/trade", async (req, res) => {
    try {
      ...
      const record = await storage.recordLiveTradeRecord({
        ...
        initialSl: t.initial_sl ?? t.stop_loss ?? null,
        ...
        reasons: t.reasons ?? [],
        pnlUsd: t.pnl_usd ?? null,
        pnlUsdGross: t.pnl_usd_gross ?? null,
        pnlUsdCost: t.pnl_usd_cost ?? null,
        riskUsdUsed: t.risk_usd_used ?? null,
  ...
  app.patch("/api/live/trade/:id", async (req, res) => {
    try {
      ...
      await storage.updateLiveTradeRecord(id, {
        ...
        initialSl: update.initial_sl ?? undefined,
        ...
        pnlUsd: update.pnl_usd ?? undefined,
        pnlUsdGross: update.pnl_usd_gross ?? undefined,
        pnlUsdCost: update.pnl_usd_cost ?? undefined,
        riskUsdUsed: update.risk_usd_used ?? undefined,
